...
REM This script is meant to be run once to setup the example demo client.
REM Run it with one command line argument: the path to a directory where the
REM demo client will be built.  This should be a directory outside the SDK
...
set BUILD_DIR=%~f1
set DEMO_DIR=%~dp0
call :ABSPATH "%DEMO_DIR%..\..\agent\proto\content_analysis\sdk" PROTO_DIR
